        ...
        <section class="ttm-row project-style2-section clearfix">
            <div class="container">
                <div class="row">
				  ...
				  <?php
				  $gQry="SELECT * FROM company_certificates WHERE cc_status='active' ORDER BY cc_order ASC";
                        ...
                        <div class="featured-imagebox featured-imagebox-portfolio ttm-box-view-top-image">
                            <div class="ttm-box-view-content-inner">
                                ...
                                <div class="featured-thumbnail">
                                    <a href="#"> <img class="img-fluid" src="upload/<?php echo $gRow["cc_image"]; ?>" alt="image"></a>
                                </div><!-- featured-thumbnail end-->
                                <!-- ttm-box-view-overlay -->
                                <div class="ttm-box-view-overlay">
                                    <div class="featured-iconbox ttm-media-link">
                                        <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery<?php echo $img; ?>]" title="" data-rel="prettyPhoto" href="upload/<?php echo $gRow["cc_image"]; ?>"><i class="ti ti-search"></i></a>
										<?php /** / ?>
